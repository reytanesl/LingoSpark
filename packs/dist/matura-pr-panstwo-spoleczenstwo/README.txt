LingoSpark pack LS-PR-STATE
Matura PR: Państwo i społeczeństwo — 180 haseł do gier LingoSpark

180 terms in 9 sets (A, B, C, D, E, F, G, H, I).
...
4. Play: copy paste/set-A-pl.txt → https://lingospark.study → Vocab Review → Bomb Defusal.
