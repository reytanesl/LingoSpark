...
(function (global) {
    ...
    const FILL_TASKS = [
        // ——— both ages (8–9 + 10–12): only young-safe tiles ———
        // to be
        ...
        { ids: ['you', 'are', 'a', 'boy', 'dot'], gaps: [1], distractors: ['am', 'is', 'qmark'], family: 'be' },
        { ids: ['she', 'is', 'a', 'friend', 'dot'], gaps: [1], distractors: ['am', 'are', 'qmark'], family: 'be' },
        { ids: ['he', 'isnt', 'a', 'girl', 'dot'], gaps: [1], distractors: ['arent', 'am-not', 'are'], family: 'be' },
        { ids: ['they', 'arent', 'cat-pl', 'dot'], gaps: [1], distractors: ['isnt', 'am-not', 'is'], family: 'be' },
        { ids: ['i', 'am', 'a', 'boy', 'dot'], gaps: [3], distractors: ['girl', 'dog', 'qmark'], family: 'be' },
        // Wh-
        ...
        { ids: ['what', 'is', 'in', 'the', 'box', 'qmark'], gaps: [0], distractors: ['who', 'where', 'dot'], family: 'wh' },
        { ids: ['where', 'is', 'the', 'ball', 'qmark'], gaps: [3], distractors: ['bag', 'bike', 'cat'], family: 'wh' },
        { ids: ['who', 'is', 'she', 'qmark'], gaps: [0], distractors: ['what', 'where', 'dot'], family: 'wh' },
        { ids: ['how', 'is', 'he', 'qmark'], gaps: [0], distractors: ['who', 'what', 'dot'], family: 'wh' },
        { ids: ['where', 'is', 'the', 'pen', 'qmark'], gaps: [0], distractors: ['who', 'what', 'dot'], family: 'wh' },
        // and / or
        ...
        { ids: ['we', 'like', 'juice', 'or', 'water', 'dot'], gaps: [3], distractors: ['and', 'qmark', 'dont'], family: 'like' },
        { ids: ['you', 'can', 'swim', 'and', 'run', 'dot'], gaps: [3], distractors: ['or', 'qmark', 'dont'], family: 'can' },
        ...
        { ids: ['there-is', 'a', 'plant', 'near', 'the', 'window', 'dot'], gaps: [3], distractors: ['under', 'on', 'qmark'], family: 'prep' },
        { ids: ['there-is', 'a', 'bin', 'behind', 'the', 'door', 'dot'], gaps: [3], distractors: ['in-front-of', 'on', 'under'], family: 'prep' },
        { ids: ['there-is', 'a', 'ball', 'in', 'the', 'box', 'dot'], gaps: [3], distractors: ['on', 'under', 'near'], family: 'prep' },
        { ids: ['there-is', 'a', 'book', 'on', 'the', 'shelf', 'dot'], gaps: [3], distractors: ['in', 'under', 'behind'], family: 'prep' },
        { ids: ['there-are', 'shoe-pl', 'under', 'the', 'bed', 'dot'], gaps: [2], distractors: ['on', 'in', 'near'], family: 'prep' },
        ...
        { ids: ['there-is', 'an', 'orange', 'in', 'the', 'bag', 'dot'], gaps: [1], distractors: ['a', 'some', 'any'], family: 'art' },
        { ids: ['there-is', 'a', 'cup', 'on', 'the', 'table', 'dot'], gaps: [0], distractors: ['there-are', 'is-there', 'qmark'], family: 'is' },
        { ids: ['there-are', 'two', 'chair-pl', 'next-to', 'the', 'desk', 'dot'], gaps: [0], distractors: ['there-is', 'there-isnt', 'qmark'], family: 'are' },
        { ids: ['there-isnt', 'a', 'dog', 'in', 'the', 'car', 'dot'], gaps: [0], distractors: ['there-arent', 'there-is', 'qmark'], family: 'is' },
        { ids: ['are-there', 'any', 'book-pl', 'on', 'the', 'shelf', 'qmark'], gaps: [0], distractors: ['is-there', 'there-are', 'dot'], family: 'are' },
        ...
        { ids: ['there-is', 'a', 'clock', 'on', 'the', 'wall', 'dot'], gaps: [2], distractors: ['mirror', 'poster', 'lamp'], family: 'is' },
        { ids: ['there-are', 'two', 'bag-pl', 'near', 'the', 'door', 'dot'], gaps: [1], distractors: ['some', 'any', 'a'], family: 'are' },
        // food / like
        ...
        { ids: ['i', 'have-got', 'a', 'mobile', 'dot'], gaps: [3], distractors: ['bag', 'book', 'qmark'], family: 'have' },
        ...
        { ids: ['i', 'havent-got', 'a', 'car', 'dot'], gaps: [1], distractors: ['hasnt-got', 'have-got', 'is'], family: 'have' },
        { ids: ['they', 'have-got', 'a', 'ball', 'dot'], gaps: [3], distractors: ['bike', 'doll', 'teddy'], family: 'have' },
        { ids: ['he', 'has-got', 'an', 'apple', 'dot'], gaps: [2], distractors: ['a', 'some', 'any'], family: 'have' },
        { ids: ['she', 'has-got', 'a', 'coat', 'and', 'a', 'hat', 'dot'], gaps: [3], distractors: ['shoe', 'sock', 'glove'], family: 'have' },
        { ids: ['we', 'have-got', 'two', 'bag-pl', 'dot'], gaps: [3], distractors: ['book-pl', 'pen-pl', 'qmark'], family: 'have' },
        // school
        { ids: ['there-is', 'a', 'pencil', 'in', 'the', 'pencil-case', 'dot'], gaps: [2], distractors: ['pen', 'ruler', 'rubber'], family: 'is' },
        { ids: ['there-are', 'two', 'book-pl', 'on', 'the', 'desk', 'dot'], gaps: [1], distractors: ['some', 'any', 'a'], family: 'are' },
        { ids: ['i', 'have-got', 'a', 'ruler', 'and', 'a', 'rubber', 'dot'], gaps: [3], distractors: ['crayon', 'pen', 'qmark'], family: 'have' },
        { ids: ['there-is', 'a', 'notebook', 'in', 'the', 'bag', 'dot'], gaps: [2], distractors: ['book', 'pen', 'crayon'], family: 'is' },
        { ids: ['she', 'has-got', 'a', 'crayon', 'dot'], gaps: [3], distractors: ['pencil', 'ruler', 'rubber'], family: 'have' },
        { ids: ['there-are', 'some', 'sticker-pl', 'on', 'the', 'book', 'dot'], gaps: [1], distractors: ['any', 'a', 'two'], family: 'are' },
        // can + verbs
        ...
        { ids: ['he', 'cant', 'ride', 'a', 'bike', 'dot'], gaps: [1], distractors: ['can', 'dont', 'like'], family: 'can' },
        ...
        { ids: ['you', 'can', 'sing', 'dot'], gaps: [2], distractors: ['dance', 'draw', 'read'], family: 'can' },
        { ids: ['i', 'cant', 'jump', 'dot'], gaps: [1], distractors: ['can', 'dont', 'like'], family: 'can' },
        { ids: ['he', 'can', 'kick', 'a', 'ball', 'dot'], gaps: [2], distractors: ['throw', 'catch', 'jump'], family: 'can' },
        { ids: ['she', 'can', 'read', 'a', 'book', 'dot'], gaps: [2], distractors: ['write', 'draw', 'paint'], family: 'can' },
        { ids: ['we', 'cant', 'swim', 'dot'], gaps: [2], distractors: ['run', 'jump', 'dance'], family: 'can' },
        { ids: ['they', 'can', 'eat', 'pizza', 'dot'], gaps: [2], distractors: ['drink', 'cook', 'like'], family: 'can' },
        // animals (young-safe)
        ...
        { ids: ['there-is', 'a', 'doll', 'on', 'the', 'bed', 'dot'], gaps: [2], distractors: ['teddy', 'ball', 'toy'], family: 'is' },
        // clothes (young-safe)
        { ids: ['i', 'have-got', 'a', 'shoe', 'dot'], gaps: [3], distractors: ['hat', 'coat', 'sock'], family: 'have' },
        { ids: ['she', 'has-got', 'a', 'glove', 'dot'], gaps: [3], distractors: ['sock', 'hat', 'coat'], family: 'have' },
        // punct focus
        { ids: ['i', 'can', 'run', 'dot'], gaps: [3], distractors: ['qmark', 'and', 'or'], family: 'can' },
        { ids: ['is-there', 'a', 'pen', 'in', 'the', 'bag', 'qmark'], gaps: [6], distractors: ['dot', 'and', 'or'], family: 'is' },
        { ids: ['where', 'is', 'the', 'cat', 'qmark'], gaps: [4], distractors: ['dot', 'and', 'or'], family: 'wh' },
        { ids: ['they', 'are', 'friend-pl', 'dot'], gaps: [3], distractors: ['qmark', 'and', 'or'], family: 'be' },
        ...
        { ids: ['when', 'are', 'you', 'outside', 'qmark'], gaps: [0], distractors: ['why', 'how', 'dot'], family: 'wh', ages: ['older'] },
        { ids: ['why', 'are', 'the', 'book-pl', 'on', 'the', 'floor', 'qmark'], gaps: [0], distractors: ['when', 'where', 'dot'], family: 'wh', ages: ['older'] },
        { ids: ['where', 'is', 'the', 'umbrella', 'qmark'], gaps: [3], distractors: ['bag', 'coat', 'ticket'], family: 'wh', ages: ['older'] },
        { ids: ['what', 'is', 'in', 'the', 'drawer', 'qmark'], gaps: [0], distractors: ['who', 'when', 'dot'], family: 'wh', ages: ['older'] },
        ...
        { ids: ['there-is', 'a', 'photo', 'upstairs', 'dot'], gaps: [3], distractors: ['downstairs', 'outside', 'near'], family: 'prep', ages: ['older'] },
        { ids: ['there-are', 'shoe-pl', 'downstairs', 'dot'], gaps: [2], distractors: ['upstairs', 'outside', 'near'], family: 'prep', ages: ['older'] },
        ...
        { ids: ['there-is', 'a', 'mouse', 'behind', 'the', 'fridge', 'dot'], gaps: [2], distractors: ['rabbit', 'duck', 'cat'], family: 'is', ages: ['older'] },
        ...
        { ids: ['there-is', 'a', 'sofa', 'in', 'the', 'living-room', 'dot'], gaps: [5], distractors: ['kitchen', 'bedroom', 'balcony'], family: 'is', ages: ['older'] },
        { ids: ['there-is', 'a', 'plant', 'on', 'the', 'balcony', 'dot'], gaps: [5], distractors: ['kitchen', 'garden', 'park'], family: 'is', ages: ['older'] },
        { ids: ['there-is', 'a', 'cooker', 'next-to', 'the', 'fridge', 'dot'], gaps: [2], distractors: ['sink', 'towel', 'cupboard'], family: 'is', ages: ['older'] },
        { ids: ['there-is', 'a', 'sink', 'in', 'the', 'kitchen', 'dot'], gaps: [2], distractors: ['fridge', 'cooker', 'towel'], family: 'is', ages: ['older'] },
        { ids: ['can', 'you', 'swim', 'qmark'], gaps: [3], distractors: ['dot', 'and', 'must'], family: 'can', ages: ['older'] },
        { ids: ['can', 'he', 'ride', 'a', 'scooter', 'qmark'], gaps: [0], distractors: ['must', 'dont', 'dot'], family: 'can', ages: ['older'] },
        ...
        { ids: ['she', 'has-got', 'a', 'camera', 'dot'], gaps: [3], distractors: ['tablet', 'radio', 'ticket'], family: 'have', ages: ['older'] },
        { ids: ['he', 'has-got', 'a', 't-shirt', 'dot'], gaps: [3], distractors: ['jumper', 'skirt', 'qmark'], family: 'have', ages: ['older'] },
        { ids: ['i', 'have-got', 'a', 'jumper', 'dot'], gaps: [3], distractors: ['uniform', 'trainer', 'skirt'], family: 'have', ages: ['older'] },
        { ids: ['they', 'have-got', 'a', 'guitar', 'dot'], gaps: [3], distractors: ['scooter', 'magazine', 'photo'], family: 'have', ages: ['older'] },
        ...
        { ids: ['there-are', 'three', 'ticket-pl', 'in', 'the', 'bag', 'dot'], gaps: [1], distractors: ['one', 'two', 'any'], family: 'are', ages: ['older'] },
        ...
        { ids: ['she', 'must', 'study', 'dot'], gaps: [1], distractors: ['can', 'like', 'have-to'], family: 'must', ages: ['older'] },
        { ids: ['he', 'have-to', 'wait', 'dot'], gaps: [1], distractors: ['must', 'can', 'dont'], family: 'must', ages: ['older'] },
        { ids: ['you', 'dont', 'have-to', 'run', 'dot'], gaps: [3], distractors: ['listen', 'tidy', 'shout'], family: 'must', ages: ['older'] },
        { ids: ['we', 'must', 'help', 'dot'], gaps: [2], distractors: ['clean', 'wash', 'wait'], family: 'must', ages: ['older'] },
        { ids: ['i', 'have-to', 'ask', 'dot'], gaps: [2], distractors: ['pack', 'study', 'tidy'], family: 'must', ages: ['older'] },
        { ids: ['there-is', 'a', 'poster', 'on', 'the', 'noticeboard', 'dot'], gaps: [5], distractors: ['whiteboard', 'wall', 'door'], family: 'is', ages: ['older'] },
        { ids: ['there-are', 'some', 'stamp-pl', 'in', 'the', 'drawer', 'dot'], gaps: [1], distractors: ['any', 'a', 'three'], family: 'are', ages: ['older'] },
        { ids: ['are-there', 'any', 'sticker-pl', 'on', 'the', 'whiteboard', 'qmark'], gaps: [1], distractors: ['some', 'a', 'dot'], family: 'are', ages: ['older'] },
        { ids: ['there-arent', 'any', 'bus-pl', 'near', 'the', 'park', 'dot'], gaps: [1], distractors: ['some', 'a', 'two'], family: 'are', ages: ['older'] },
        { ids: ['i', 'like', 'guitar', 'dot'], gaps: [2], distractors: ['scooter', 'magazine', 'camera'], family: 'like', ages: ['older'] },
